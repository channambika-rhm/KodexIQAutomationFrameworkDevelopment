...
//			sh.getRow(rowNum).getCell(i).setCellType(CellType.STRING);
			...
			DataFormatter formatter = new DataFormatter(); // using DataFormatter instead of deprcating setCellType method
			formatter.formatCellValue(sh.getRow(rowNum).getCell(i));
